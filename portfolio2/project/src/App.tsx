...
function App() {
  ...
  const hackathons = [
    {
      name: "World's Largest Hackathon Organised by Bolt",
      image: "/bolt-hackathon.png",
      description: "Participated in the world's largest hackathon organized by Bolt, where I built a web application platform 'WhoGoFixAm' - a vocational learning and service platform, where users can learn vocational skills, join a list of verified professionals and can get hired to help make fixes.",
      projects: [
        {
              ...
              <div key={index} className="bg-slate-700/50 p-8 rounded-xl">
                ...
                {hackathon.image && (
                  <img 
                    src={hackathon.image} 
                    alt={hackathon.name} 
                    className="w-full h-64 object-cover rounded-lg mb-6 border border-slate-600"
                  />
                )}
